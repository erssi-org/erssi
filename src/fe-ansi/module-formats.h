...
enum {
	...
	TXT_FIRSTRUN_LOCAL_SETTING,
	TXT_FIRSTRUN_IRC_HEADER,
	TXT_FIRSTRUN_IRC_SETTING,
	TXT_FIRSTRUN_HOWTO,
...
#define TXT_SIDEPANEL_NICK_OWNER format_find_tag(MODULE_NAME, "sidepanel_nick_owner")
#define TXT_SIDEPANEL_NICK_ADMIN format_find_tag(MODULE_NAME, "sidepanel_nick_admin")
#define TXT_SIDEPANEL_NICK_OP format_find_tag(MODULE_NAME, "sidepanel_nick_op")
#define TXT_SIDEPANEL_NICK_HALFOP format_find_tag(MODULE_NAME, "sidepanel_nick_halfop")
...
#define TXT_SIDEPANEL_NICK_OWNER_STATUS format_find_tag(MODULE_NAME, "sidepanel_nick_owner_status")
#define TXT_SIDEPANEL_NICK_ADMIN_STATUS format_find_tag(MODULE_NAME, "sidepanel_nick_admin_status")
#define TXT_SIDEPANEL_NICK_OP_STATUS format_find_tag(MODULE_NAME, "sidepanel_nick_op_status")
#define TXT_SIDEPANEL_NICK_HALFOP_STATUS format_find_tag(MODULE_NAME, "sidepanel_nick_halfop_status")
